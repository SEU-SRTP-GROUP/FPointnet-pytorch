...
def test_from_rgb_detection(output_filename, result_dir=None):
    ...
    for batch_idx in range(num_batches):
        ...
        # 见train_util.py中 from_rgb_detection=True直接调用的get_batch_from_rgb_detection部分
