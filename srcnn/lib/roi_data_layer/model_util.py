...
def get_loss(mask_label, center_label, \
    ...
    corners_loss_gt = torch.norm(corners_3d_pred-corners_3d_gt,dim=2)
    corners_loss_gt_flip = torch.norm(corners_3d_pred-corners_3d_gt_flip,dim=2)
    corners_loss = huber_loss(torch.min(corners_loss_gt,corners_loss_gt_flip),delta=1.0)
